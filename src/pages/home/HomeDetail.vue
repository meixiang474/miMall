      ...
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-version clearfix">
            <h2>选择版本</h2>
            <div
            :class="['fl', 'phone', {'checked': version === 1}]"
            @click="version=1"
            >
            6GB+64GB 全网通
            </div>
            <div
            :class="['fl', 'phone', {'checked': version === 2}]"
            @click="version=2"
            >
            4GB+64GB 移动4G
            </div>
...
import ProductParam from '../../components/common/ProductParams'
  ...
  methods: {
    addCart () {
      this.axios.post('/carts', {
        ...
        this.$store.dispatch('saveCartCount', res.cartTotalQuantity.length)
